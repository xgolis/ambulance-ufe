...
describe('tg-ambulance-wl-list', () => {
  ...
  it('renders sample entries', async () => {
    ...
    const page = await newSpecPage({
      ...
      html: `<tg-ambulance-wl-list ambulance-id="test-ambulance" api-base="http://test/api"></tg-ambulance-wl-list>`,
    });
  ...
  it('renders error message on network issues', async () => {
    ...
    const page = await newSpecPage({
      components: [TgAmbulanceWlList],  //
      html: `<tg-ambulance-wl-list ambulance-id="test-ambulance" api-base="http://test/api"></-ambulance-wl-list>`,  //
    });
