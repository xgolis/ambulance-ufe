 ...
 afterEach(() => { mock.reset(); });
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      ...
      html: `<tg-ambulance-wl-editor entry-id="test-entry"
  ...
  it('first text field is patient name', async () => {
    ...
    const page = await newSpecPage({
       components: [TgAmbulanceWlEditor],
       html: `<tg-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></tg-ambulance-wl-editor>`,
    });
